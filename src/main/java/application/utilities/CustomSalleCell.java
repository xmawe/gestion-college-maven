        ...
        return new TableCell<Map<String, String>, String>() {
            ...
            protected void updateItem(String item, boolean empty) {
                ...
                if (empty || item == null) {
                    ...
                    String niveauIconPath = "/images/icons/Salle Cours.png"; // Default path if class name
                                                                                   // doesn't match
                    // Adjust this logic based on your class naming convention
                    if (item.contains("Salle")) {
                        niveauIconPath = "/images/icons/Salle Cours.png"; // Update path for local resource
                    } else if (item.contains("Laboratoire")) {
                        niveauIconPath = "/images/icons/Laboratoire.png"; // Update path for local resource
                    } else if (item.contains("Terrain")) {
                        niveauIconPath = "/images/icons/Sport.png"; // Update path for local resource
                    }
